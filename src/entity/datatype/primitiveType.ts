...
class IntType extends WholePrimitiveType {
    ...
    canImplicitCastTo(targetType: DataType): boolean {
        return this.toString() == targetType.toString() || targetType == PrimitiveTypes.float || targetType == PrimitiveTypes.int
    }
...
class FloatType extends ArithPrimitiveType {
    ...
    canExplicitCastTo(targetType: DataType): boolean {
        return this.canImplicitCastTo(targetType) || targetType == PrimitiveTypes.int || targetType == PrimitiveTypes.char;
    }
}
...
class CharType extends WholePrimitiveType {
    ...
    canImplicitCastTo(targetType: DataType): boolean {
        return this.toString() == targetType.toString() || targetType == PrimitiveTypes.int || targetType == PrimitiveTypes.float
    }
